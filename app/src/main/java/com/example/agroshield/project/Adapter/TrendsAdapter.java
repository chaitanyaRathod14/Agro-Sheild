...
import com.example.agroshield.project.Activity.ArticleActivity;
...
public class TrendsAdapter extends RecyclerView.Adapter<TrendsAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        int drawableResourceId = holder.itemView.getResources().getIdentifier(
                items.get(position).getPicAddress(), "drawable", holder.itemView.getContext().getPackageName()
        );
        ...
        // Set OnClickListener to navigate to ArticleActivity
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(context, ArticleActivity.class);
            // Optional: pass additional data to ArticleActivity if needed
